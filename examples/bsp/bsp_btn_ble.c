...
#define	BTN_ID_ADVERTISING_STOP	  0
#define	BTN_ID_ADVERTISING_START  1

#define	BTN_ID_KEY_0			  0
#define	BTN_ID_KEY_1              1


#define	BTN_ACTION_ADVERTISING_START	BSP_BUTTON_ACTION_LONG_PUSH
#define	BTN_ACTION_ADVERTISING_STOP		BSP_BUTTON_ACTION_LONG_PUSH
...
static uint32_t connection_buttons_configure()
{
	...
	err_code = bsp_event_to_button_action_assign(BTN_ID_KEY_0,
                                                 BSP_BUTTON_ACTION_RELEASE,
                                                 BSP_EVENT_KEY_0);
    RETURN_ON_ERROR_NOT_INVALID_PARAM(err_code);

    err_code = bsp_event_to_button_action_assign(BTN_ID_KEY_1,
                                                 BSP_BUTTON_ACTION_RELEASE,
                                                 BSP_EVENT_KEY_1);
    RETURN_ON_ERROR_NOT_INVALID_PARAM(err_code);
	...
	err_code = bsp_event_to_button_action_assign(BTN_ID_DISCONNECT + 1,
                                                 BTN_ACTION_DISCONNECT,
                                                 BSP_EVENT_DISCONNECT);
    RETURN_ON_ERROR_NOT_INVALID_PARAM(err_code);
...
static uint32_t advertising_buttons_configure()
{
    ...
    err_code = bsp_event_to_button_action_assign(BTN_ID_ADVERTISING_START,
                                                 BTN_ACTION_ADVERTISING_START,
                                                 BSP_EVENT_ADVERTISING_START);
    RETURN_ON_ERROR_NOT_INVALID_PARAM(err_code);

    err_code = bsp_event_to_button_action_assign(BTN_ID_ADVERTISING_STOP,
                                                 BTN_ACTION_ADVERTISING_STOP,
