...
static uint32_t led_char_add(ble_lbs_t * p_lbs, const ble_lbs_init_t * p_lbs_init)
{
    ...
    char_md.p_char_user_desc  = (uint8_t *)LED_CHAR_USER_DESCRIPTORS;
	char_md.char_user_desc_size = strlen(LED_CHAR_USER_DESCRIPTORS);
	char_md.char_user_desc_max_size = strlen(LED_CHAR_USER_DESCRIPTORS);
...
static uint32_t button_char_add(ble_lbs_t * p_lbs, const ble_lbs_init_t * p_lbs_init)
{
    ...
    char_md.p_char_user_desc  = (uint8_t *)BUTTON_CHAR_USER_DESCRIPTORS;
	char_md.char_user_desc_size	= strlen(BUTTON_CHAR_USER_DESCRIPTORS);
	char_md.char_user_desc_max_size = strlen(BUTTON_CHAR_USER_DESCRIPTORS);
    char_md.p_char_pf         = NULL;
    char_md.p_user_desc_md    = NULL;
...
uint32_t ble_lbs_init(ble_lbs_t * p_lbs, const ble_lbs_init_t * p_lbs_init)
{
    ...
    err_code = sd_ble_uuid_vs_add(&base_uuid, &p_lbs->uuid_type);/* 自定义UUID调用 */
